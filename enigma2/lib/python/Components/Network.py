...
class Network:
	...
	def getFriendlyAdapterDescription(self, iface):
		...
		if moduledir:
			...
			if name in ('ath_pci','ath5k','ath9k','ar928x'):
				name = 'Atheros'
			elif name in ('rt73','rt73usb','rt2870sta','rt3070sta','rt5370sta','rt5572sta'):
				name = 'Ralink'
			elif name == 'zd1211b':
				name = 'Zydas'
	...
	def writeDefaultNetworkConfig(self,mode='lan', callback = None):
		...
		if mode == 'wlan':
			fp.write("auto " + iface + "\n")
			fp.write("iface " + iface + " inet dhcp\n")
		if mode == 'wlan-mpci':
			fp.write("auto ath0\n")
		...
		if mode == 'wlan':
			...
			self.commands.append("ifconfig " + iface + " up")
		if mode == 'wlan-mpci':
			self.commands.append("ifconfig eth0 down")
	...
	def detectWlanModule(self, iface = None):
		...
		if moduledir:
			...
			if module in ('ath_pci','ath5k','ath9k','ar928x'):
				return 'madwifi'
			if module in ('rt73','rt73usb','rt2870sta','rt3070sta','rt5370sta'):
				return 'wext'
			if module == 'zd1211b':
				return 'zydas'
		return 'wext'
