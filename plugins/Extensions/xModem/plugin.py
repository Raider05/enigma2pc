...
def Plugins(**kwargs):
	return [PluginDescriptor(where = PluginDescriptor.WHERE_AUTOSTART, fnc = autostart),
		PluginDescriptor(name="xModem", description="Plugin to configure modem and connect to the Internet", where = PluginDescriptor.WHERE_PLUGINMENU, icon="xmodem.png", fnc=main)]
